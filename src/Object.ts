...
class Lala {
    ...
    myAlert(text) {
        ...
        if (thereTime) {
            ...
            const closeIcon: HTMLElement = document.querySelector(".close")!;
    ...
    changePage(btn: HTMLElement) {
        btn.onclick = () => {
            const mainlala: HTMLElement = document.getElementById("main")!;
            var bodyChild = mainlala.children;
